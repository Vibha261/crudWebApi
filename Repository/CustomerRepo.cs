...
namespace WebApplication1.Repository
{
    public class CustomerRepo : ICustomerRepo
    {
        ...
        public CustomerRepo()
        {
            connectionString = @"Data Source=APINP-ELPTBICKH\SQLEXPRESS;Initial Catalog=chub;Persist Security Info=True;User ID=tap2023;Password=tap2023;Encrypt=False";
        }
